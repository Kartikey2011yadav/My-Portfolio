import { curve, heroBackground, heroBackground2, robot, heroImg } from "../../assets";
import Button from "../common/Button";
import Section from "../common/Section";
import { BackgroundCircles, BottomLine, Gradient } from "../design/Hero";
import { heroIcons, heroData } from "../../constants";
      ...
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          ...
          <div className="flex justify-center">
            <Button className="w-auto" href={heroData.ctaLink}>
              {heroData.ctaText}
            </Button>
          </div>
        </div>
            ...
            <div className="relative bg-n-7 rounded-[1rem]">
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                <Generating
                  ...
                  text={"Loading My Life's Journey . . . "}
                />
        ...
        <TechLogos className="hidden relative z-10 lg:block" />
        <TechSlider />
      </div>
