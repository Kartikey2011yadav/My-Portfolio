...
export const Gradient = () => {
  return (
    <>
      <div className="relative z-1 h-6 mx-2.5 bg-n-8 shadow-xl rounded-b-[1.25rem] lg:h-6 lg:mx-8" />
...
export const BottomLine = () => {
  return (
    <>
      <div className="hidden absolute top-[71.25rem] left-10 right-10 h-0.25 bg-color-5 pointer-events-none xl:block" />

      <PlusSvg className="hidden absolute top-[70.9375rem] left-[2.1875rem] z-2 pointer-events-none xl:block" />

      <PlusSvg className="hidden absolute top-[70.9375rem] right-[2.1875rem] z-2 pointer-events-none xl:block" />
    </>
  );
};
  ...
  return (
    <div className="absolute -top-[42.375rem] left-1/2 w-[78rem] aspect-square border border-n-2/5 rounded-full -translate-x-1/2 md:-top-[38.5rem] xl:-top-[32rem]">
      ...
      <MouseParallax strength={0.07} parallaxContainerRef={parallaxRef}>
        <div className="absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom rotate-[52deg]">
          <div
